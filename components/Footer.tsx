      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-700 dark:text-gray-400 text-sm max-w-sm leading-relaxed">
              The marketplace for Universal Profile grid templates. Customize
              your LUKSO profile with beautiful layouts stored on-chain.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="text-gray-900 dark:text-white font-medium mb-4 text-sm">
              Resources
            </h4>
            <ul className="space-y-2.5">
              <li>
                <a
                  ...
                  className="text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm flex items-center gap-1.5 transition-colors"
                >
                  LUKSO Docs
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/5 flex items-center justify-center text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-white/10 transition-all"
                title="GitHub"
              >
        ...
        {/* Bottom */}
        <div className="border-t border-gray-200 dark:border-white/5 mt-10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
