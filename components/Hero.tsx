    ...
    return (
        <section className="mb-12">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-base sm:text-lg text-gray-700 dark:text-gray-400 max-w-xl mx-auto leading-relaxed">
                    Discover and apply beautiful grid templates to your LUKSO
                    Universal Profile with a single transaction.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="card rounded-xl p-5">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-400 leading-relaxed">
                        Curated collection of stunning grid layouts for every
                        style, use and audience.
                    </p>
                </div>
                ...
                <div className="card rounded-xl p-5">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-400 leading-relaxed">
                        Apply a grid template directly to your profile in one
                        click with one single transaction.
                    </p>
                </div>
                ...
                <div className="card rounded-xl p-5">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-400 leading-relaxed">
                        Find the encoded grid data value of each template to set
                        under your Universal Profile.
                    </p>
                </div>
            </div>
        </section>
