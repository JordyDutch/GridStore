...
export function TemplateModal({ template, onClose }: TemplateModalProps) {
    ...
    // Determine if we can show a live preview (community templates with profileAddress)
    const canShowLivePreview = !!template.profileAddress;
    const previewUrl = template.profileAddress
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute -top-2 -right-2 lg:top-0 lg:right-0 z-20 p-2 rounded-lg bg-gray-800/90 text-white hover:bg-gray-700 dark:bg-white/90 dark:text-gray-900 dark:hover:bg-white transition-colors shadow-md"
                ...
                >
                    ...
                    <div className="p-6 overflow-y-auto">
                        ...
                        {!hasGridData && !isFetchingGridData && !fetchError && (
                            <div className="mb-5 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl text-amber-400 text-sm flex items-center gap-3">
                                <AlertCircle className="w-5 h-5 flex-shrink-0" />
                                This template preview doesn&apos;t have IPFS
                                data configured yet. Coming soon!
                            </div>
                        )}
                        ...
                        {isConnected && (
                            <div className="mb-5 p-4 bg-amber-50 border border-amber-300 rounded-xl text-amber-900 dark:bg-amber-500/10 dark:border-amber-500/30 dark:text-amber-200 text-sm flex items-center gap-3">
                                ...
                                <span>
                                    If you have an existing grid setup, by
                                    clicking the button below, you are aware
                                    that this will replace entirely your
                                    existing grid.
                                </span>
                            </div>
                        )}
                        ...
                        <div className="mb-5">
                            ...
                            <p className="text-gray-600 dark:text-gray-500 text-xs leading-relaxed">
                                Click on the Apply to Profile button below or
                            ...
                            {manualInstructionsOpen && (
                                <div className="px-4 py-4 space-y-4 bg-gray-50 dark:bg-white/[0.02] border-t border-gray-200 dark:border-white/10">
                                    <div className="text-gray-700 dark:text-gray-400 text-sm leading-relaxed mb-1">
                                        <p className="mb-3">
                                            To set this Grid, set the following
                                            metadata on your Universal Profile
                                            smart contract.
                                        </p>
                                        <p className="mb-1">
                                            1. Got to the{" "}
                                        ...
                                        <p className="mb-1">
                                            3. Select the &quot;setData&quot;
                                            function from the dropdown menu.
                                        </p>
                                        <p className="mb-1">
                                            4. Enter the following values below:
                                        </p>
                                        <p className="mb-1">
                                        ...
                                        <p className="mb-1">
                                            6. Wait for the transaction to be
                                            confirmed.
                                        </p>
                                        <p className="mb-1">
                                            7. The Grid should now be set on
                        ...
                        {!isConnected && (
                            <p className="text-center text-gray-500 text-sm mt-4">
                                Connect your Universal Profile to apply this
                                template
                            </p>
                        )}
                    </div>
